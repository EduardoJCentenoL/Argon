...
class ShiftController extends Controller
{
    ...
    public function store(ShiftRequest $request){
        ...
        return redirect()->route('shifts.index')->with('success','Turno Creado');
    }
    ...
    public function update(ShiftRequest $request, Shift $shift){
        ...
        return redirect()->route('shifts.index')->with('success', 'Turno Actualizado');
    }
    ...
    public function destroy(string $id){
        ...
        return redirect()->route('shifts.index')->with('success', 'Turno Eliminado');
    }
}
